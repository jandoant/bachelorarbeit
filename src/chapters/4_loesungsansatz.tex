...
Als sehr einfaches Beispiel lässt sich das \prettyref{lis:simplestp} herbeiziehen. Es beschreibt einen Punkt in Kartesischen Koordinaten (Klasse "`CARTESIAN\_POINT"') mit einer ID von 173 sowie den Koordinaten x=10,0mm, y=15.0mm und z=30,0mm. Weiterhin ist zu erkennen, dass hierbei das Attribut "`name"' leer ist. Dies ist bei den meisten geometrischen Entitäten der Fall. Das ist allerdings nicht von großer Bedeutung, da, wie oben beschrieben die ID als Identifikator genutzt wird.    
