...
Hat man einen Punkt $\vv{p_{xyz}}$ in globalen Koordinaten gegeben, so berechnet sich seine Position im lokalen Kordinatensystem entsprechend \prettyref{eq:pxyz2puvw}. 
...
Bei der Diskretisierung planarer Flächen wird unterschieden zwischen kreisförmigen Umrandungen und Unmrandungen, die aus einem Polygon bestehen.
